...
<Project Type="Project" LVVersion="17008000">
	...
	<Property Name="varPersistentID:{04FD033B-BAAA-4682-B660-BB856E2CC928}" Type="Ref">/NI-myRIO-1900-unimelb-1/LIDAR Data Variables.lvlib/Mask (from VFH)</Property>
	<Property Name="varPersistentID:{0922FBAC-EDEF-4C4D-9481-6B906DF7BF2F}" Type="Ref">/NI-myRIO-1900-unimelb-1/Robot Data Variables.lvlib/Wall Tracking Boolean</Property>
	<Property Name="varPersistentID:{195EF429-C55F-4D30-B048-EE0216B9EA4E}" Type="Ref">/NI-myRIO-1900-unimelb-1/LIDAR Data Variables.lvlib/Robot Current XY Position (m)</Property>
	<Property Name="varPersistentID:{2DA37D00-8BBC-4C10-8E60-EA4C65CCFF61}" Type="Ref">/NI-myRIO-1900-unimelb-1/LIDAR Data Variables.lvlib/LIDAR Right y-avg (m)</Property>
	...
	<Property Name="varPersistentID:{CD420E93-671B-41F5-BE74-5BF26D2894C0}" Type="Ref">/NI-myRIO-1900-unimelb-1/Robot Data Variables.lvlib/Gyroscope Z-angular (dps)</Property>
	<Property Name="varPersistentID:{DB5C0F77-E871-4B83-9BDB-A1C8568353BC}" Type="Ref">/NI-myRIO-1900-unimelb-1/LIDAR Data Variables.lvlib/Outer Threshold (m)</Property>
	<Property Name="varPersistentID:{E190A03E-BE3F-4916-8BAE-8E236D6F2A0E}" Type="Ref">/NI-myRIO-1900-unimelb-1/LIDAR Data Variables.lvlib/Stop VFH Visual</Property>
	<Property Name="varPersistentID:{EB63EA82-C7E9-4D81-BD1D-16B349DF1B3F}" Type="Ref">/NI-myRIO-1900-unimelb-1/LIDAR Data Variables.lvlib/Robot Current Heading (rad)</Property>
	<Property Name="varPersistentID:{F8EEE2EC-B1AD-4FF7-B800-4FA8E36FC769}" Type="Ref">/NI-myRIO-1900-unimelb-1/LIDAR Data Variables.lvlib/Histogram (from VFH)</Property>
	...
	<Item Name="NI-myRIO-1900-unimelb-1" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-unimelb-1</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="LIDAR Parsing VI" Type="Folder">
			<Item Name="File read sim.vi" Type="VI" URL="../LIDAR Parsing VI/File read sim.vi"/>
			<Item Name="gen angle array.vi" Type="VI" URL="../LIDAR Parsing VI/gen angle array.vi"/>
			<Item Name="hex parse.vi" Type="VI" URL="../LIDAR Parsing VI/hex parse.vi"/>
			<Item Name="labview parse dist.vi" Type="VI" URL="../LIDAR Parsing VI/labview parse dist.vi"/>
			<Item Name="lidar pulse wrapper.vi" Type="VI" URL="../LIDAR Parsing VI/lidar pulse wrapper.vi"/>
			<Item Name="Lidar Wrapper (SubVI).vi" Type="VI" URL="../LIDAR Parsing VI/Lidar Wrapper (SubVI).vi"/>
			<Item Name="type pun.vi" Type="VI" URL="../LIDAR Parsing VI/type pun.vi"/>
			<Item Name="Untitled Project 1.aliases" Type="Document" URL="../LIDAR Parsing VI/Untitled Project 1.aliases"/>
			<Item Name="Untitled Project 1.lvlps" Type="Document" URL="../LIDAR Parsing VI/Untitled Project 1.lvlps"/>
			<Item Name="Untitled Project 1.lvproj" Type="Document" URL="../LIDAR Parsing VI/Untitled Project 1.lvproj"/>
			<Item Name="Visa Open wrapper.vi" Type="VI" URL="../LIDAR Parsing VI/Visa Open wrapper.vi"/>
			<Item Name="Visa sim.vi" Type="VI" URL="../LIDAR Parsing VI/Visa sim.vi"/>
		</Item>
		<Item Name="Unused VIs" Type="Folder">
			<Item Name="AvoidObstacle.vi" Type="VI" URL="../AvoidObstacle.vi"/>
			<Item Name="FPGA myRIO Ultrasound (Left).vi" Type="VI" URL="../FPGA myRIO Ultrasound (Left).vi"/>
			<Item Name="FPGA myRIO Ultrasound (Right).vi" Type="VI" URL="../FPGA myRIO Ultrasound (Right).vi"/>
			<Item Name="IR Range Finder (left).vi" Type="VI" URL="../IR Range Finder (left).vi"/>
			<Item Name="IR Range Finder (right).vi" Type="VI" URL="../IR Range Finder (right).vi"/>
			<Item Name="ultrasonic_global.vi" Type="VI" URL="../ultrasonic_global.vi"/>
			<Item Name="IR_global.vi" Type="VI" URL="../IR_global.vi"/>
			<Item Name="global_stop.vi" Type="VI" URL="../global_stop.vi"/>
			...
			<Item Name="global_output.vi" Type="VI" URL="../global_output.vi"/>
		</Item>
		<Item Name="Compass Code (added calibration)" Type="Folder">
			<Item Name="Compass demo.aliases" Type="Document" URL="../Compass Code (added calibration)/Compass demo.aliases"/>
			<Item Name="Compass demo.lvlps" Type="Document" URL="../Compass Code (added calibration)/Compass demo.lvlps"/>
			<Item Name="Compass demo.lvproj" Type="Document" URL="../Compass Code (added calibration)/Compass demo.lvproj"/>
			<Item Name="Compass.vi" Type="VI" URL="../Compass Code (added calibration)/Compass.vi"/>
		</Item>
		<Item Name="Gyroscope Code (calibration)" Type="Folder">
			<Item Name="Cumulative Moving Average (SubVI).vi" Type="VI" URL="../Gyroscope Code (calibration)/Cumulative Moving Average (SubVI).vi"/>
			<Item Name="Gyroscope demo.aliases" Type="Document" URL="../Gyroscope Code (calibration)/Gyroscope demo.aliases"/>
			<Item Name="Gyroscope demo.lvlps" Type="Document" URL="../Gyroscope Code (calibration)/Gyroscope demo.lvlps"/>
		...
		<Item Name="CountToDistance (SubVI).vi" Type="VI" URL="../CountToDistance (SubVI).vi"/>
		<Item Name="MotorDirectionHandler (SubVI).vi" Type="VI" URL="../MotorDirectionHandler (SubVI).vi"/>
		<Item Name="SimplePidController (SubVI).vi" Type="VI" URL="../SimplePidController (SubVI).vi"/>
		<Item Name="AnglePidController (SubVI).vi" Type="VI" URL="../AnglePidController (SubVI).vi"/>
		<Item Name="Angle PID.vi" Type="VI" URL="../Angle PID.vi"/>
		<Item Name="DeadReckoning (SubVI).vi" Type="VI" URL="../DeadReckoning (SubVI).vi"/>
		<Item Name="Simple XY Plot (SubVI).vi" Type="VI" URL="../Simple XY Plot (SubVI).vi"/>
		<Item Name="Kalman Filter CV Model (SubVI).vi" Type="VI" URL="../Kalman Filter CV Model (SubVI).vi"/>
		<Item Name="Find Relative Goal Location.vi" Type="VI" URL="../Find Relative Goal Location.vi"/>
		<Item Name="LIDAR_global.vi" Type="VI" URL="../LIDAR_global.vi"/>
		...
		<Item Name="Map Function (SubVI).vi" Type="VI" URL="../Map Function (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Draw XY Heading.vi" Type="VI" URL="../Simulated Mecanum Robot/Simulated VFH TEST support/Draw XY Heading.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
